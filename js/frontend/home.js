! function(e) {
    ...
    (i = function() {
...
}), $(".js-present-slider").slick({
        infinite: !0,
        slidesToShow: 1,
        slidesToScroll: 1,
        prevArrow: $(".present__button--left"),
        nextArrow: $(".present__button--right"),
        variableWidth: !0,
        responsive: [{
            breakpoint: 992,
            settings: {
        ...
        var i = e(".animate-text__item").length,
            t = e(".nimate-text__item").height(),
            o = i * t;

        function s() {
            e("#sliderAnimate").delay(500).animate({
                bottom: +t
            }, 400, function() {
                e("#sliderAnimate .animate-text__item:first-child").appendTo("#sliderAnimate"), e("#sliderAnimate").css("bottom", "")
            })
        }
        e(".animate-text").css({
            height: t
        }), e(".animate-text__cont").css({
            height: o,
            marginTop: -t
        }), e(".animate-text__item").css({
            opacity: 1
        }), e("#sliderAnimate .animate-text__item:last-child").prependTo("#sliderAnimate")
    }), $(window).width() > 991 && $(".menu2>li").hover(function() {
        $(this).children(".expand_menu").toggleClass("d-block"), $(this).toggleClass("is-opened")
    }), $(".js-header-search_button").on("click", function() {
        $(".hamburger-menu .line-top, #menu, .mobile_menu").toggleClass("current"), $(".hamburger-menu .line-center").toggleClass("current"), $(".hamburger-menu .line-bottom").toggleClass("current"), $(".js-header-search_button").toggleClass("d-none")
    }), $(".hamburger-menu").on("click", function() {
        $(".js-header-search_button").toggleClass("d-none")
    }), $(".mobile_menu-full-elements").on("click", () => {
        setTimeout(function() {
            0 == !$(".show").length ? $(".mobile_menu__actions, .header-search--pannel").addClass("shadow") : $(".mobile_menu__actions, .header-search--pannel").removeClass("shadow")
        }, 500)
    }),
    function(e) {
        "use strict";
        ...
        function i(i) {
            void 0 !== window.recaptchaKey && (e("input[name='recaptcha_response']").val(window.Laravel.cT + ":" + i), e("#recaptchaForm").modal("hide")), e.ajax({
                beforeSend: function(i) {
                    i.setRequestHeader("X-CSRF-TOKEN", e('meta[name="csrf-token"]').attr("content"))
                },
                type: "POST",
                url: window.ajaxUrls.homeContForm,
                dataType: "json",
                data: e("#sendContactForm").serialize(),
                success: function(i) {
                    e("#alertSuccessModal").modal("show"), resetMainFormErrorsById("sendContactForm", !0)
                },
                error: function(i) {
                    let t = e.parseJSON(i.responseText);
                    422 === i.status ? (resetMainFormErrorsById("sendContactForm"), setErrorsForMainForm(t.errors, "sendContactForm")) : void 0 !== t.message && "" != t.message && alert(t.message)
                }
            })
        }
        window.needShowLogginModal && window.location.hash && "#signin" == window.location.hash && e("#modal-sign-in").modal("show"), e("body").on("submit", "#sendContactForm", function(e) {
            e.preventDefault(), void 0 !== window.recaptchaKey ? window.showRecaptcha(i) : i()
        }), e("body").on("click", ".filter__category", function(i) {
            i.preventDefault(), i.stopPropagation(), console.log("test");
            let t = e(this).data("tools-block-type");
            console.log(t), e(".filter__category").removeClass("is-active"), e(this).addClass("is-active"), e(".tools-block-results").hide(), e(".tools-block-results[data-tools-block-type=" + t + "]").show()
        }), window.afterRegister && showSuccessAlertModal("Thank You!", "Thank you for becoming a TinyWow Supporter.  <br>We truly appreciate it.  <br>We’re hard at work building great new tools, and now that you’re a supporting member, you’ll get first access as we launch.  <br>Cancel easily at any time from the Billing page, or simply shoot us an email and we’ll take care of it for you.", "I’m Awesome"), e("body").on("click", ".js-recent-tool", function(i) {
            i.preventDefault(), i.stopPropagation(), window.appEvents.recentToolClick(), window.location = e(this).data("tool-url")
        })
    }(jQuery);